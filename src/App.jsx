...
const projects = [
  {
    ...
    description:
      '负责抖音官旗号及产品内容运营，根据品牌调性、目标人群洞察和销售节点，利用 AI 数据分析制定阶段性内容计划，围绕产品认知、使用场景和促销转化搭建内容矩阵；利用 AI 结合有米云、云图分析竞品与人群偏好，制定阶段性内容矩阵；通过 AI 辅助脚本生成、混剪提效及衰退素材诊断，快速调整前三秒钩子与卖点顺序。累计交付原创素材 900+ 条、跑量素材 300+ 条，支撑全域月 GMV 稳定 600 万+、ROI 稳定 4 以上；618 期间单日 GMV 峰值 65 万+，环比提升 185%。素材点击率由 2.8% 提升至 5.58%，转化率提升 22%，素材生命周期延长至 10—14 天。利用 Agent 每日跟进投放数据，与投放团队协同定位问题、输出迭代方向，直播间进房成本下降 18%。',
    image: '/assets/project-joyoung-cyber-final.png',
    metrics: ['原创素材 900+', '跑量素材 300+', '月 GMV 600W+', 'ROI 4+', 'CTR 5.58%', '进房成本 -18%'],
    accent: 'cyan',
  },
  {
    number: '02',
